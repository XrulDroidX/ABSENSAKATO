...
const createIcon = (paths: React.ReactNode, displayName: string) => {
  const Icon = ({ size = 20, className = "", strokeWidth = 2, ...props }: IconProps) => (
    <svg
...
export const CalendarClock = createIcon(<><path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5" /><path d="M16 2v4" /><path d="M8 2v4" /><path d="M3 10h5" /><path d="M21 10h-5.5" /><circle cx="17.5" cy="17.5" r="3.5" /><path d="M19.5 19.5 17.5 17.5V15.5" /></>, 'CalendarClock');
...
export const FileBarChart = createIcon(<><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14 2 14 8 20 8" /><path d="M12 18v-6" /><path d="M8 18v-1" /><path d="M16 18v-3" /></>, 'FileBarChart');
export const FileText = createIcon(<><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14 2 14 8 20 8" /><line x1="16" x2="8" y1="13" y2="13" /><line x1="16" x2="8" y1="17" y2="17" /><line x1="10" x2="8" y1="9" y2="9" /></>, 'FileText');
...
export const Power = createIcon(<path d="M18.36 6.64a9 9 0 1 1-12.73 0" /><line x1="12" x2="12" y1="2" y2="12" />, 'Power');
