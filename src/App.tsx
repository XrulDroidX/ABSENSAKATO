    ...
    React.useEffect(() => {
        ...
        StorageService.init()
            ...
            .catch(e => {
                ...
                removeSplash(); // Remove splash anyway so user sees error boundary if needed
            });

        // Failsafe: Remove splash after 4 seconds regardless of init status
        const failsafe = setTimeout(() => {
            console.warn("[App] Force removing splash screen");
            removeSplash();
        }, 4000);
